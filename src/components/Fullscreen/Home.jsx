                ...
                <div className='col-lg-4 order-2 order-lg-2 d-flex flex-column justify-content-center' style={{ backgroundColor: 'grey', padding: '10px 50px 50px 50px', borderRadius: '13px' }}>
                  <form>
                    ...
                    <div class="mb-3">
                      ...
                      <input type="phoneNo " class="form-control required" value={phone} onChange={(e) => { setPhone(e.target.value) }} />
                    </div>
                    <div class="mb-3">
                    ...
                    <div style={{ display: 'flex' }}>
                      <button type="submit" id="next-btn" style={{ justifyContent: 'center' }} onSubmit={(e) => handleSubmit(e)}>Create Will</button>
                    </div>
                  </form>
                </div>
              </div>
