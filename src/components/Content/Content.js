                        ...
                        <form id='beneficiary-form'>
                            <div className='form-row'>
                                ...
                                <div className='form-item'>
                                    ...
                                    <input value={benRelation} onChange={(e) => setBenRelation(e.target.value)}></input>
                                </div>
                                <div className='form-item'>
                                    <p style={{ width: '175px', fontSize: '16px' }} className="note-para">(eg. friend, son, sister, etc.)</p>
                                </div>
                    ...
                    <TabPanel>
                        <Tabs selectedIndex={tabIndex1}>
                            ...
                            <TabPanel>
                                ...
                                <h3 onClick={() => setMovVisible(movVisible === "none" ? 'flex' : 'none')} style={{ display: 'flex', justifyContent: 'space-between', cursor: 'pointer' }} className="asset-tab">My Movable Assets<ArrowDropDownIcon /></h3>
                                ...
                                <div style={{ display: movVisible, transition: '0.3s' }}>
                                    <form style={{ width: '100%' }}>
                                        ...
                                        {(assetType === "Mutual Funds" || assetType === "Jewellery" || assetType === "Any other Investments" || assetType === "Electronics and Appliances" || assetType === "Digital Asset" || assetType === "Business Asset") ?
                                            < div className="form-row">
                                                <div className="form-item">
                                                    <label>Description of {assetType}</label>
                                                    <textarea style={{ width: '400px', height: '150px' }} value={description} onChange={(e) => setDescription(e.target.value)}></textarea>
                                                </div>
                                            </div>
                                            : ''
                                        }
                            ...
                            <TabPanel>
                                ...
                                <div style={{ justifyContent: "right", marginTop: '20px' }} className='form-row'>
                                    <a onClick={() => { setTabIndex1(0) }} id="next-btn">PREV: Asset Details</a>
